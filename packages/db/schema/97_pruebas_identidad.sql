...
SET ROLE lis_app; SET lis.empresa_id = :'hos'; SET lis.usuario_id = :'u_hos';
...
SET ROLE lis_app; SET lis.empresa_id = :'lab'; SET lis.usuario_id = :'u_lab';
...
SET ROLE lis_app;
SET lis.empresa_id = :'hos'; SELECT count(*) AS ve_el_hospital FROM core.mensaje;
SET lis.empresa_id = :'lab'; SELECT count(*) AS ve_el_laboratorio FROM core.mensaje;
RESET ROLE;
