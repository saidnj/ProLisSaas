...
\echo '    esperado: t  (usuario_puede mira la sede del contexto: se pone antes)'
SET lis.sucursal_id = :'suc';
SELECT core.usuario_puede('orden.crear', :u_ana) AS en_la_sede;
RESET lis.sucursal_id;


\echo ''
\echo '=== 6 · el operador apaga lab_clinico: se cae el acceso ============='
\echo '    esperado: f, y la fila de rol_permiso INTACTA'
...
\echo '    esperado: t, sin que el administrador rearme nada'
UPDATE plataforma.modulo_sucursal
