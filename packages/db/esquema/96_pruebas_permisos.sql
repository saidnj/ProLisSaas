...
WHERE r.empresa_id = :emp AND r.nombre NOT IN ('Administrador', 'Propietario')
...
\echo '    esperado: f, f, t  (con la sede en el contexto: usuario_puede la exige siempre)'
SET lis.sucursal_id = :'suc';
...
SET ROLE lis_app; SET lis.empresa_id = :'emp'; SET lis.sucursal_id = :'suc'; SET lis.usuario_id = :'u_ana';
...
SET ROLE lis_app; SET lis.empresa_id = :'emp'; SET lis.sucursal_id = :'suc'; SET lis.usuario_id = :'u_bio';
...
SET ROLE lis_app; SET lis.empresa_id = :'emp'; SET lis.sucursal_id = :'suc'; SET lis.usuario_id = :'u_rec';
